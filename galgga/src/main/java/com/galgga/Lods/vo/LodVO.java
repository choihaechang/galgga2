...
public class LodVO {
	...
	public float getLod_starpoint() {
		return lod_starpoint;
	}
	public void setLod_starpoint(float lod_starpoint) {
		this.lod_starpoint = lod_starpoint;
	}
