...
<div class="main">
 <div class="addMemberText">회원 가입</div>
  ...
  <div class="normalUserAdd"><img class="normalUserAdd" src="${contextPath}/resources/image/admin.PNG" alt="관리자"/></div>
      <div class="normal">회원가입이 성공적으로 완료 되었습니다</div>
      <div class="normalButton">
      		<a href="${contextPath }/main/main.do" class="myButton">메인으로가기</a>
        	<a href="${contextPath }/member/loginForm.do" class="myButton2">로그인하러가기</a>
      </div>
  </div>
