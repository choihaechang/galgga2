...
<body>
    ...
    <div class="mypageleftbox">
      <div class="leftbox1">
      <a href="/galgga/member/UpdateView.do" class="lefttext1">회원정보 수정</a>
      </div>
    ...
    <div class="mypage-point">
	 	<div class="userName">${memberInfo.member_name }님</div>
	    <div class="userInfo">
...
<span>
    ...
    <button type="button" class="lodgingbutton">예약취소</button>
		...
		<tbody>
			<tr> 
				<td><a href="/galgga/lodge/campingMain_select.do"><input type="checkbox" name="lodgingcheckbox" value="">${res.lod_name }</a></td>
				<td>2022-05-23</td>
