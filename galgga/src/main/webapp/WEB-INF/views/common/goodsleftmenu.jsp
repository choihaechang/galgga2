...
<body>
<div class="leftquickmenu1">
	<div style="margin:auto; width: 310px;">
	<img id="weather" src="${contextPath}/resources/image/weather.PNG">
	</div>
  ...
  <div class="leftquickmenu2" style="padding-bottom: 10px;">
      <div class="text3" >최근 본 상품</div><br>
      <a href="/galgga/campingMain.do">
    <img class="ping7" src="${contextPath}/resources/image/tent.png" alt="최근 본 상품"></a>
